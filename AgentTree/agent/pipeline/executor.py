...
from AgentTree.agent.intelligence import get_executor_response  # Function to generate executor responses using LLM
...
class Executor:
    ...
    def __init__(self, goal: str, document: str):
        """
    ...
    def execute_plan(self, plan: str, backpack: list[dict]) -> str:
        ...
        """
        return get_executor_response(self.goal, self.document, backpack, plan)