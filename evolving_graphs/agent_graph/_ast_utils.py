...
# Utility functions for Python AST analysis including syntax validation and architectural rule checking.
#

import ast  # For parsing Python code to check syntax and structure
import re  # For regex-based validation checks
from collections import defaultdict  # For DRY violation detection
from typing import Dict, List, Any  # Type hints for function signatures


def pre_validate_syntax(code: str) -> dict:
    """
...
def check_architecture_rules_ast(code: str) -> dict:
    """
    Checks the generated code against architectural rules defined in rules.md using AST analysis.
