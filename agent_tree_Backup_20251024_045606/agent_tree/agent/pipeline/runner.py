...
from ..utils.state_manager import save_document_state as state_manager  # Utility for saving document state
    ...
    def run_pipeline(self) -> dict:
        ...
        try:
            ...
            if verification_result['success']:
                ...
                save_document_state(self.current_code_state, self.main_goal)
                return {
                    'success': True,
